...
from .handlers import RequirementChecker
...
class ProjectCreator:
    ...
    def _create_virtualenv(self, pbar):
        ...
        stdout, error = self._execute_command(["virtualenv", "venv"], "Failed to create virtualenv", pbar)
        if error:
    ...
    def _rollback(self):
        ...
        try:
            shutil.rmtree(os.path.join(self._project_location, self._project_name))
